...
const officeAvailabilityCallout = "Now offering telehealth appointments.";
        ...
        >
            <div className="container">
                ...
                <div id="navbarBasicExample" className={"navbar-menu " + (active ? "is-active" : "")}>
                    <div className="navbar-start" style={{ flexGrow: 1, flexShrink: 1, display: "flex" }}>
                        <Link
                            className="navbar-item has-text-centered is-hidden-mobile"
                            to="/appointments"
                            style={{ marginLeft: "5vmin", marginRight: "5vmin" }}
                        >
                            <FontAwesomeIcon icon={faExclamationCircle} className="has-text-warning" />
                            <div
                                style={{
                                    marginLeft: "1vmin",
                                    marginRight: "1vmin"
                    ...
                    <div className="navbar-end">
                        <Link className="navbar-item has-text-dark" activeClassName="navbar-item is-active" to="/">
                            Home
                        </Link>
                        <Link
                        ...
                        <Link className="navbar-item" to="https://www.valant.io/portal/FamilyPsychiatryCounseling">
