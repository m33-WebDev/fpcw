          ...
          <Columns vCentered={true}>
            ...
            <Columns.Column>
              ...
              <Typography family="secondary">
                ...
                effective, non-invasive, non-drug treatment for depression
                without the side effects of medications. The treatment requires
                no sedation or anesthesia. It also has no recovery time, meaning
                patients can resume normal activity - including driving -
          ...
          <Columns vCentered={true} gap={8}>
            <Columns.Column>
              ...
              <Typography family="secondary">
                ...
                criteria, adding TMS therapy to your existing treatment plan may
                help you achieve full remission.
              </Typography>
            </Columns.Column>
            <Columns.Column>
              <Quizlet />
