                    ...
                    <Columns vCentered={true}>
                        ...
                        <Columns.Column>
                            ...
                            <Typography>
                                ...
                                resume normal activity - including driving - immediately after sessions. Covered by most
                                insurance providers.
                            </Typography>
                            <Level>
                    ...
                    {assertions.map(assertion => (
                        <Columns.Column size={6}>
                            <Form.Field kind="group">
                                ...
                                <Form.Control>
                                    <Button
                                        color={selections[assertion.id] === true ? "success" : "white"}
                                        rounded={true}
                                ...
                                <Form.Control>
                                    <Button
                                        color={selections[assertion.id] === false ? "success" : "white"}
                                        rounded={true}
